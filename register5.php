             ...
             <div class="w3_mail_grids">
                 ...
                 <span class="input input--ichiro">
                     ...
                     <span class="input input--ichiro">
						...
						<span class="input input--ichiro">
							<input class="input__field input__field--ichiro" type="text" id="input-35" placeholder=" " required="" name="number2">
                     ...
                     <div class="col-md-4 w3_agile_mail_grid">
                         ...
                         <span class="input input--ichiro">
                             <input class="input__field input__field--ichiro" type="text" id="input-38" placeholder=" " required="" name="number4">
                     ...
                     <div class="col-md-4 w3_agile_mail_grid">
                         ...
                         <span class="input input--ichiro">
                             <input class="input__field input__field--ichiro" type="text" id="input-41" placeholder=" " required="" name="number5">
